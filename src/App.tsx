...
const App = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/login" element={user ? <ChatScreenPage /> : <Login />} />
      <Route path="/register" element={user ? <ChatScreenPage /> : <Signup />} />
      <Route path="/chats/:chatId" element={!user ? <Login /> : <ChatScreenPage />} />
